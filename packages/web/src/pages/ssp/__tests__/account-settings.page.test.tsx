...
import AccountSettingPageWithLayout from '../account-settings.page';
...
describe('AccountSettingPageWithLayout', () => {
  beforeEach(() => {
  ...
  test('renders correctly', async () => {
    const { container, findByText } = render(<AccountSettingPageWithLayout />, {
      initialState: {
        ...mockState,
        auth: {
