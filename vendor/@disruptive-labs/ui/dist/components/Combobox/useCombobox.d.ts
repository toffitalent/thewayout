...
/// <reference types="react" />
import { UseComboboxGetLabelPropsOptions, UseComboboxProps as UseDownshiftProps, UseComboboxReturnValue as UseDownshiftReturnValue } from 'downshift';
import { usePopper } from '../Popper';
export interface UseComboboxProps<Item = any> extends UseDownshiftProps<Item> {
    options: Item[];
}
export declare const useCombobox: <Item extends unknown>({ options, ...props }: UseComboboxProps<Item>) => {
    closeMenu: () => void;
    getComboboxProps: (attrs?: React.HTMLAttributes<HTMLElement>) => {
        ref: (node: Element | import("@popperjs/core").VirtualElement | null) => void;
    ...
    getInputProps: (options?: import("downshift").UseComboboxGetInputPropsOptions | undefined, otherOptions?: import("downshift").GetPropsCommonOptions | undefined) => any;
    getItemProps: (options: import("downshift").UseComboboxGetItemPropsOptions<Item>) => any;
    getLabelProps: (attrs?: UseComboboxGetLabelPropsOptions) => any;
    ...
    getPopperProps: (props?: import("react").HTMLAttributes<HTMLDivElement>, ref?: import("../../utils").ReactRef<HTMLDivElement>) => {
...
export interface UseComboboxReturnValue<Item = any> {
    closeMenu: UseDownshiftReturnValue<Item>['closeMenu'];
    getComboboxProps: ReturnType<typeof usePopper>['getReferenceProps'];
    getInputProps: UseDownshiftReturnValue<Item>['getInputProps'];
    getItemProps: UseDownshiftReturnValue<Item>['getItemProps'];
    getLabelProps: UseDownshiftReturnValue<Item>['getLabelProps'];
    getMenuProps: UseDownshiftReturnValue<Item>['getMenuProps'];
    getPopperProps: ReturnType<typeof usePopper>['getPopperProps'];
    getToggleButtonProps: UseDownshiftReturnValue<Item>['getToggleButtonProps'];
    hasLabel: boolean;
    highlightedIndex: number;
    inputValue: string;
    isOpen: boolean;
    items: Item[];
    itemToString: (item: Item) => string;
    openMenu: UseDownshiftReturnValue<Item>['openMenu'];
    options: Item[];
    reset: UseDownshiftReturnValue<Item>['reset'];
    selectedItem: UseDownshiftReturnValue<Item>['selectedItem'];
    selectItem: UseDownshiftReturnValue<Item>['selectItem'];
    setHighlightedIndex: UseDownshiftReturnValue<Item>['setHighlightedIndex'];
    setInputValue: UseDownshiftReturnValue<Item>['setInputValue'];
    toggleMenu: UseDownshiftReturnValue<Item>['toggleMenu'];
}
